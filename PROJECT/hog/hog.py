...
def boar_brawl(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 2
    "*** YOUR CODE HERE ***"
    ten_num = opponent_score//10%10
    one_num = player_score%10

    res = abs(ten_num - one_num)
    if res == 0:
        return 1
    return 3 * res
    # END PROBLEM 2
...
def max_scoring_num_rolls(dice=six_sided, times_called=1000):
    ...
    "*** YOUR CODE HERE ***"
    i, res = 1, 1
    largestNum = make_averaged(roll_dice, times_called)(i, dice)
    i += 1
    while i <= 10:
        tempNum = make_averaged(roll_dice, times_called)(i, dice)
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    """
    # BEGIN PROBLEM 12
    threshold = sus_update(6, score, opponent_score) - score
    return sus_strategy(score, opponent_score, threshold, 6) 
    # END PROBLEM 12
